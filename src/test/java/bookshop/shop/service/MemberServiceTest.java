...
class MemberServiceTest {
    ...
    void getAccountTest() {
        ...
        String maskedAccount = memberService.getAccount("test@gmail.com", "테스트");
        assertThat(maskedAccount).isEqualTo("testAc*****");
    }

    @Test
    void getAccountFailTest() {
        MemberRegisterRequest request = createRequest("testAccount", "test@gmail.com", "testPW123!", "testPW123!", "테스트");
        Long savedId = memberService.createMember(request);

        assertThatThrownBy(() -> memberService.getAccount("tet@gmail.com", "테스트")).isInstanceOf(MemberNotFoundException.class);
